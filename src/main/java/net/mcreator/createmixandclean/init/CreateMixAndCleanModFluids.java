...
public class CreateMixAndCleanModFluids {
	...
	public static final DeferredHolder<Fluid, FlowingFluid> HYDROGEN_GAS = REGISTRY.register("hydrogen_gas", () -> new HydrogenGasFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_HYDROGEN_GAS = REGISTRY.register("flowing_hydrogen_gas", () -> new HydrogenGasFluid.Flowing());
	public static final DeferredHolder<Fluid, FlowingFluid> HYDROCHLORIC_ACID = REGISTRY.register("hydrochloric_acid", () -> new HydrochloricAcidFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_HYDROCHLORIC_ACID = REGISTRY.register("flowing_hydrochloric_acid", () -> new HydrochloricAcidFluid.Flowing());
	public static final DeferredHolder<Fluid, FlowingFluid> IRON_SLURRY = REGISTRY.register("iron_slurry", () -> new IronSlurryFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_IRON_SLURRY = REGISTRY.register("flowing_iron_slurry", () -> new IronSlurryFluid.Flowing());
	public static final DeferredHolder<Fluid, FlowingFluid> OXYGEN_GAS = REGISTRY.register("oxygen_gas", () -> new OxygenGasFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_OXYGEN_GAS = REGISTRY.register("flowing_oxygen_gas", () -> new OxygenGasFluid.Flowing());
	public static final DeferredHolder<Fluid, FlowingFluid> LIQUID_AIR = REGISTRY.register("liquid_air", () -> new LiquidAirFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_LIQUID_AIR = REGISTRY.register("flowing_liquid_air", () -> new LiquidAirFluid.Flowing());
	public static final DeferredHolder<Fluid, FlowingFluid> NITROGEN_GAS = REGISTRY.register("nitrogen_gas", () -> new NitrogenGasFluid.Source());
	public static final DeferredHolder<Fluid, FlowingFluid> FLOWING_NITROGEN_GAS = REGISTRY.register("flowing_nitrogen_gas", () -> new NitrogenGasFluid.Flowing());
