...
@EventBusSubscriber
public class OxygenGasFluidType extends FluidType {
	public OxygenGasFluidType() {
		super(FluidType.Properties.create().fallDistanceModifier(0F).canExtinguish(true).supportsBoating(true).canHydrate(true).motionScale(0D).density(-200).viscosity(2).sound(SoundActions.BUCKET_FILL, SoundEvents.BUCKET_FILL)
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		...
		}, CreateMixAndCleanModFluidTypes.OXYGEN_GAS_TYPE.get());
	}
}