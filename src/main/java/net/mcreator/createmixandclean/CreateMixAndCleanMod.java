...
@Mod("create_mix_and_clean")
public class CreateMixAndCleanMod {
	...
	public CreateMixAndCleanMod(IEventBus modEventBus) {
		...
		CreateMixAndCleanModSounds.REGISTRY.register(modEventBus);
		CreateMixAndCleanModBlocks.REGISTRY.register(modEventBus);
		CreateMixAndCleanModBlockEntities.REGISTRY.register(modEventBus);
		CreateMixAndCleanModItems.REGISTRY.register(modEventBus);
		CreateMixAndCleanModTabs.REGISTRY.register(modEventBus);
		CreateMixAndCleanModVariables.ATTACHMENT_TYPES.register(modEventBus);
